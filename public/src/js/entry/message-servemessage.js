/**
 * Created by AnThen on 2016/10/24.
 * 微信二维码-列表 es6+react版
 */
/*构造页面*/
        ...
        return (
            <header className="page-body-header">
                <div className="text-box">
                    <span className="title">服务通知短信</span>
                </div>
            </header>
        )
    }
...
class Manage extends React.Component {
    ...
    updateMsg(msg,id,signId,signContent,materialName,smsType,stockTotal){
        ...
        let thisStockTotal = {},showHideHintParam;
            ...
            buttons: [
                {
                    ...
                    handler: function (self) {
                        let original = $.trim($('#modals-crowd-original').val()) || false;
