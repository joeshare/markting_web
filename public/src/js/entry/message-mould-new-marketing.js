...
class Manage extends React.Component {
    ...
    */
    render() {
        return (
            <div className="mould-new-marketing">
                <SubHead />
                <div className="content">
                    <div className="tabs-area">
                        <div className="tabs-box">
                            <ul id="first-layer" className="tabs">
                                <li className="tab"><a className="active" href="javascript:void(0)" onClick={this.channelChange.bind(this,'marketing')}>营销短信模版</a></li>
                                <li className="tab"><a href="javascript:void(0)" onClick={this.channelChange.bind(this,'serve')}>服务通知模版</a></li>
                            </ul>
                        </div>
                    </div>
                                        ...
                                        <div className="line-con">
                                            <div className="radio-area">
                                                <div className="radio-box">
                                                    <input className="type1" name="materialType" type="radio" id="type1" checked={this.state.type[0]} onClick={this.typeChange.bind(this,0)}/>
                                                    <label htmlFor="type1">固定模板</label>
                                                </div>
                                                <div className="radio-box">
                                                    <input className="type1" name="materialType" type="radio" id="type2" checked={this.state.type[1]} onClick={this.typeChange.bind(this,1)}/>
                                                    <label htmlFor="type2">变量模板</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
